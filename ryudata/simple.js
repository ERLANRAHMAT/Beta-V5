...
exports.smenu = (pushname, namabot) => {
	return`Halo Kak *${pushname}* 👋
Saya Adalah *${namabot}* Yang Dibuat Oleh LannOfc Menggunakan Base Dari Dika Ardnt (Hisoka-Morou)
Perlu Diketahui Bot Ini Memakai Program Multi Device Beta Dari WhatsApp Messenger.
Sehingga Bisa Online 24 Jam Tanpa Sinyal Internet/Wifi
